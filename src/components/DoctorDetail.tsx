                                                    ...
                                                    {isEditing ? (
                                                        <div className="relative">
                                                            ...
                                                            {showLocExpCity && expenseCities.filter(c => c.toLowerCase().includes(locExpCitySearch.toLowerCase())).length > 0 && (
                                                                <div className="absolute z-50 min-w-[250px] mt-0.5 bg-white border border-slate-200 rounded shadow-lg max-h-64 overflow-y-auto">
                                                                    {expenseCities.filter(c => c.toLowerCase().includes(locExpCitySearch.toLowerCase())).map(c => (
                                                    ...
                                                    {isEditing ? (
                                                        <div className="relative">
                                                            ...
                                                            {showLocDasCity && dasCities.filter(c => c.toLowerCase().includes(locDasCitySearch.toLowerCase())).length > 0 && (
                                                                <div className="absolute z-50 min-w-[250px] mt-0.5 bg-white border border-slate-200 rounded shadow-lg max-h-64 overflow-y-auto">
                                                                    {dasCities.filter(c => c.toLowerCase().includes(locDasCitySearch.toLowerCase())).map(c => (
                                                    ...
                                                    {isEditing ? (
                                                        <div className="relative">
                                                            ...
                                                            {showLocBrick && bricks.filter(b => b.toLowerCase().includes(locBrickSearch.toLowerCase())).length > 0 && (
                                                                <div className="absolute z-50 min-w-[250px] mt-0.5 bg-white border border-slate-200 rounded shadow-lg max-h-64 overflow-y-auto">
                                                                    {bricks.filter(b => b.toLowerCase().includes(locBrickSearch.toLowerCase())).map(b => (
